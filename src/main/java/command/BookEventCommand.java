...
/**
 * {@link BookEventCommand} allows {@link model.Consumer Consumers} to book
 * tickets for an
...
public class BookEventCommand implements ICommand<Booking> {
     ...
     * @verifies.that if the ticket price is greater than 0, the payment is
     *                successful before creating the booking
     */
    @Override
    ...
    /**
     * @return A unique booking number corresponding to a {@link Booking} if
