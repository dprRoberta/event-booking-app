...
/**
 * {@link CancelBookingCommand} allows {@link model.Consumer}s to cancel a
 * {@link Booking} given
 * its unique booking number. The command applies for the currently logged-in
 * user.
 */
public class CancelBookingCommand implements ICommand<Boolean> {
    ...
    /**
     * @param bookingNumber booking number uniquely identifying a {@link Booking}
     *                      that was previously
