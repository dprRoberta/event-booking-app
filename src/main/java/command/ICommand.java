...
/**
 * {@link ICommand} is the interface implemented by all commands. This common
 ...
 * Every command must specify a type parameter, which is the command result
 * type.
 */
public interface ICommand<T> {
     ...
     *
     * @return The command result (type varies by command) if successful and null or
     *         false otherwise.
     */
    T getResult();
}
