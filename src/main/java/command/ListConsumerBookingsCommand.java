...
/**
 * {@link ListConsumerBookingsCommand} allows a logged-in {@link Consumer} to
 * get a list of all their own
 * {@link Booking}s.
 */
public class ListConsumerBookingsCommand implements ICommand<List<Booking>> {
    ...
    /**
     * @return A list of the {@link Consumer}'s {@link Booking}s if successful and
     *         null otherwise
     */
    @Override
