...
/**
 * {@link LoginCommand} allows a previously registered {@link User} to log in to
 * the system by providing their login
 * details.
 */
public class LoginCommand implements ICommand<User> {
     ...
     * @verifies.that the password matches the saved password for the corresponding
     *                account
     */
    @Override
