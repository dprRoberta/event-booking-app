...
/**
 * {@link RegisterStaffCommand} allows users to register a new {@link Staff}
 * account
...
public class RegisterStaffCommand implements ICommand<Staff> {
     ...
     * @param password password to log in to the system in the future. Must not be
     *                 null
     * @param secret   secret passcode only known by staff required to sign up for a
     *                 staff account
     */
     ...
     * @verifies.that the secret matches the one that is set up for this
     *                organisation
    ...
    public void execute(Context context, IView view) {
        ...
        if (currentUser != null) {
            view.displayFailure(
                    ...
                    LogStatus.REGISTER_STAFF_LOGGED_IN,
        ...
        if (email == null || password == null || secret == null) {
            view.displayFailure(
                    ...
                    LogStatus.REGISTER_STAFF_FIELDS_CANNOT_BE_NULL,
        ...
        if (!context.getOrgSecret().equals(secret)) {
            view.displayFailure(
                    "RegisterStaffCommand",
                    LogStatus.REGISTER_STAFF_WRONG_STAFF_SECRET,
                    Map.of("secret", "***"));
            newStaffResult = null;
            return;
        }
        ...
        if (allUsers.containsKey(email)) {
            view.displayFailure(
                    "RegisterStaffCommand",
                    LogStatus.REGISTER_STAFF_EMAIL_ALREADY_REGISTERED,
                    Map.of("email", email));
            newStaffResult = null;
            return;
        }
    ...
    private enum LogStatus {
        ...
        REGISTER_STAFF_LOGGED_IN,
        REGISTER_STAFF_FIELDS_CANNOT_BE_NULL,
        REGISTER_STAFF_WRONG_STAFF_SECRET,
        REGISTER_STAFF_EMAIL_ALREADY_REGISTERED,
        STAFF_LOGIN_SUCCESS
    }
}
