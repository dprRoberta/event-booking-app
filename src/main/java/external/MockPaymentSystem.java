 ...
 * <p>
 * This class should keep track of payments made, so that when a refund is
 * requested, it can check whether the
 * transactionAmount corresponds to a previously made payment (or if something
 * fishy may be going on).
 * Watch out for transactions made between the same people for the same amount
 * more than once!
 * <p>
 * Hint: you may find it helpful to use an inner Transaction class, overriding
...
public class MockPaymentSystem implements PaymentSystem, Serializable {
    ...
    private static class Transaction implements Serializable {
        ...
        public boolean equals(Object obj) {
            ...
            return buyer.equals(other.buyer) && seller.equals(other.seller)
