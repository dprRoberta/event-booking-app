...
public class ConsoleView implements IView {
    ...
    public static final int CONSUMER_MENU_LIST_EVENTS_MAX_DISTANCE = 6;
    public static final int CONSUMER_MENU_REVIEW_EVENT = 7;
    ...
    /**
     * Show menu of options that can lead to the other menus or quitting the
     * application
     */
    @Override
     ...
     *
     * @param callerName human-readable name (usually in the format
     *                   ClassName.MethodName) where the message is logged from
     * @param result     a single string representing the result of the operation
     ...
     * @param callerName     human-readable name (usually in the format
     *                       ClassName.MethodName) where the message is logged from
     * @param result         a single string representing the result of the
     *                       operation that is being logged
     * @param additionalInfo a map containing any additional information that may
     *                       help to explain the result,
     *                       the keys should be variable names and the values should
     *                       be their values.
     *                       For convenience, the values are allowed to be any
     *                       {@link Object}s that get converted
     *                       to {@link String}s
     */
    @Override
